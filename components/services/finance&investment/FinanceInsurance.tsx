...
const financeInsuranceCards = [
  {
    title: "Health Insurance",
    description:
      "Choose suitable health insurance coverage to help manage healthcare-related financial risks.",
  },
  {
    title: "Life Insurance",
    description:
      "Secure financial protection for you and your family through appropriate life insurance solutions.",
  },
  {
    title: "Property Insurance",
    description:
      "Protect your property against applicable risks and unforeseen losses.",
  },
  {
    title: "Group Insurance",
    description:
      "Provide insurance coverage for employees or eligible groups through suitable group insurance solutions.",
  },
...
export default function FinanceInsurance() {
  return (
    <section className="w-full bg-white px-6 py-12 sm:px-10 md:px-12 lg:px-[120px] lg:py-12">
      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-12">
        ...
        <div className="flex w-full flex-col items-start gap-4">
          ...
          <p className="max-w-[1000px] text-left font-sans text-[18px] font-normal leading-7 text-[#525252] md:text-[20px] md:leading-7">
            Protect yourself, your assets, and your business with suitable insurance solutions.
          </p>
      ...
      {financeInsuranceCards.map((card) => (
        <div
          key={card.title}
