...
const accountTaxationCards = [
 
  {
    title: "Income Tax Return",
    description:
      "Prepare and file income tax returns accurately while ensuring compliance with applicable income tax requirements.",
  },
  {
    title: "Goods and Service Tax",
    description:
      "Get support with GST compliance, filings, and related requirements to keep your business tax obligations on track.",
  },
  {
    title: "TDS",
    description:
      "Manage tax deducted at source requirements, filings, and related compliance with accurate and timely support.",
  },
...
export default function AccountTaxationCards() {
  return (
      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-12">
        ...
        <div className="flex w-full flex-col items-start gap-4">
          ...
          <p className="max-w-[1000px] text-left font-sans text-[18px] font-normal leading-7 text-[#525252] md:text-[20px] md:leading-7">
           Manage your tax obligations with reliable filing, compliance, and taxation support.
          </p>
