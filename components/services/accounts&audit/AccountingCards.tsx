...
const accountingCards = [
 
  {
    title: "Accounting",
    description:
      "Maintain accurate and organized financial records with professional accounting support tailored to your business requirements.",
  },
  {
    title: "Book keeping",
    description:
      "Keep your day-to-day financial transactions properly recorded and organized for accurate financial management and reporting.",
  },
];
