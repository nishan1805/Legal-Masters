...
const complianceCards = [
 
  {
    ...
    description:
      "Evalute the uniqueness of your invention through a comprehensive prior-art patent search.",
  },
  {
    title: "Patent Provisinal Registration",
    description:
      "Secure an early filling date for your invention with a provisional patent application.",
  },
  {
    title: "Patent Final Application",
    description:
      "Complete your patent registration by filling the final specification and required documentation.",
  },
  {
    title: "Application for Design Registration",
    description:
      "Protect the unique visual appearance and industrial design of your product through design registration.",
  },
